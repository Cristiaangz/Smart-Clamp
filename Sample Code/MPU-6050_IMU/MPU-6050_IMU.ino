...
void loop(){
  ...
  gyro_x += raw_gyro_x * 0.0000611;                                   //Calculate the traveled pitch angle and add this to the angle_pitch variable
  gyro_y += raw_gyro_y* 0.0000611;                                    //Calculate the traveled roll angle and add this to the angle_roll variable
  
  //0.000001066 = 0.0000611 * (3.142(PI) / 180degr) The Arduino sin function is in radians
  //angle_pitch += angle_roll * sin(raw_gyro_z * 0.000001066);               //If the IMU has yawed transfer the roll angle to the pitch angel
  //angle_roll -= angle_pitch * sin(raw_gyro_z * 0.000001066);               //If the IMU has yawed transfer the pitch angle to the roll angel
...
void write_SERIAL(){                                                      //Subroutine for writing the LCD
  ...
  Serial.print("\t");
  Serial.print(angle_pitch_output);    //Print Pitch number
  Serial.print("\t");
  Serial.println(angle_roll_output);    //Print Roll number
}
